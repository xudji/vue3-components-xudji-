  ...
  <div class="table-container">
    ...
    <div class="table-footer mt15">
      ...
      <div class="table-footer-tool">
        <el-tooltip content="打印表格" placement="top" effect="light">
          <el-icon
            @click="onPrintTable"
        ...
        <el-tooltip content="下载表格" placement="top" effect="light">
          <el-icon
            @click="onImportTable"
            style="cursor: pointer; margin-right: 12px"
            size="18px"
        ...
        >
          <template #reference>
            <el-icon style="cursor: pointer" size="18px"><Setting /></el-icon>
          </template>
          <template #default>
            <div class="tool-box">
              <el-tooltip content="拖动进行排序" placement="top-start">
                <el-icon style="margin-right: 12px"><Warning /></el-icon>
              </el-tooltip>
              <el-checkbox
